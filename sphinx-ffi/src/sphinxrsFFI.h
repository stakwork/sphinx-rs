...
RustBuffer uniffi_sphinxrs_fn_func_contact_pubkey_by_encrypted_child(RustBuffer seed, RustBuffer state, uint64_t child_idx, RustCallStatus *_Nonnull out_status
);
